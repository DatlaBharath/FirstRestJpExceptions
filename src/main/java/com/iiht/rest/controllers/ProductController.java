...
import com.iiht.rest.exceptions.InvalidValueException;
...
public class ProductController {
	...
	public String recive(@RequestBody Product p) throws InvalidValueException{
		if(p.getDescription().equals("male") || p.getDescription().equals("female"))
			return "hello";
		else
			throw new InvalidValueException("value provided provided is invalid");
	}
